module.exports = {
	...
	adminMenu: {
		firstMenu: {
			...
			menuOptions: ['Inserir Alunas', 'Inserir Avaliadores', 'Ver Turma', 'Mudar Turma', 'Atualizar Turma', 'Aviso Respostas'],
			menuPostback: ['inserirAlunas', 'inserirAvaliadores', 'verTurma', 'mudarTurma', 'updateTurma', 'avisoResposta'],
		},
		inserirAlunas: {
