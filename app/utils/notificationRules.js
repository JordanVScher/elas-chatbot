...
async function getNotificationRules() {
	if (process.env.ENV === 'homol') {
		return [
			{ notification_type: 1, modulo: 1, timeChange: [{ qtd: -1, type: 'days' }] },
			{ notification_type: 2, modulo: 1, timeChange: [{ qtd: -1, type: 'days' }] },
			{ notification_type: 3, modulo: 1, timeChange: [{ qtd: 0, type: 'days' }], indicado: true, reminderDate: 6 }, // eslint-disable-line object-curly-newline
			{ notification_type: 4, modulo: 1, timeChange: [{ qtd: 0, type: 'days' }] },
			...
			{ notification_type: 7, modulo: 2, timeChange: [{ qtd: 0, type: 'days' }] }, // on the second class
			...
			{ notification_type: 11, modulo: 3, timeChange: [{ qtd: -1, type: 'days' }] },
			{ notification_type: 12, modulo: 3, timeChange: [{ qtd: 0, type: 'days' }], indicado: true, familiar: true }, // eslint-disable-line object-curly-newline
