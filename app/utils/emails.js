...
Fique atenta ao seu email, você receberá na sequência algumas pré-atividades para serem feitas. Qualquer dúvida, estamos à disposição.

Beijos,
Equipe ELAS
`,
		subject: '[ INFORMAÇÕES IMPORTANTES, LOCAL E HORÁRIO DO TREINAMENTO ]',
	},
	mail2: {
		text: `Olá *|PRIMEIRO_NOME|*,  tudo bem?

Está chegando o dia de início do Programa ELAS - Turma 10!!!
...
as 4 atividades prévias até(15 dias antes do início do Módulo 1), ok ?

ATIVIDADE 1 - CONHECENDO VOCÊ MELHOR
Essa é uma atividade importante para conhecermos melhor você e suas
características.

Clique no link e preencha(Conhecendo Você Melhor): <ATIVIDADE1>

ATIVIDADE 2 - RELAÇÃO DE AVALIADORES - Como as pessoas te avaliam ?
...
ATIVIDADE 3 - SONDAGEM DE FOCO
Essa atividade é importante por que será o ponto de partida sobre
a sua evolução pessoal, algo que mediremos no final do programa.  

Clique no link e preencha: <ATIVIDADE2>

ATIVIDADE 4 - SEU INVENTÁRIO COMPORTAMENTAL
...
Após receber até(2 dias antes do início do Módulo 1), você deverá imprimir e levar para darmos uma devolutiva no primeiro módulo; -)
...
Quem me passou o seu contato foi a *|NOMEALUNA|*. Ela está fazendo um treinamento de liderança, autoconhecimento e influência, e pedimos sua ajuda para que a avalie para ajudar nas atividades do treinamento.
...
O teste leva em torno de 15 a 25 minutos, dependendo do nível de detalhamento e profundidade das suas respostas. Sabemos que seu tempo é precioso, e tenho certeza que com a sua ajuda a *|NOMEALUNA|* se desenvolverá ainda mais.
Clique no link abaixo para iniciar questionário:
<AVALIADORPRE>

Quanto ao prazo, o questionário deve ser preenchido até (2 dias antes do início do Módulo 1). Posso contar contigo?
...
Vania Teofilo
Equipe ELAS`,
		subject: 'VOCÊ FOI CONVIDADO PARA AVALIAR A *|NOMEALUNA|*',
	},
	mail4: {
...
Abraços,
Equipe ELAS`,
		subject: '[ AVALIAÇÃO 360 ] - Programa ELAS',
	},
	mail5: {
		text: `Olá, *|PRIMEIRO_NOME|*,
...
Beijos,
Equipe ELAS`,
		subject: '[ COMO FOI O MÓDULO 1 PARA VOCÊ? ] - Programa ELAS',
	},
	mail6: {
		text: `Olá *|PRIMEIRO_NOME|*!

Está chegando o 2° módulo!!!
Como o tempo passa rápido não é? Você está preparada? 
...
Equipe ELAS`,
		...
		anexo: process.env.ANEXO_MAIL06,
	},
	mail7: {
		text: `Olá , *|PRIMEIRO_NOME|*,

No domingo, (último dia do Módulo 3), faremos nossa formatura e para isso cada aluna terá que formar uma dupla e fazer uma apresentação de impacto com no máximo 5 minutos para as duas. Essa apresentação deverá ser preferencialmente em dupla.
...
Caso vocês duas optem por fazer uma apresentação que utilize algum conteúdo de mídia (música, fotos, slides), envie via email, (2 dias antes do início do módulo 3), no email: mentoria@programaelas.com.br. Também é bom trazer uma cópia no pen drive para garantir.
...
Beijos,
Equipe ELAS`,
		subject: '[ COMO FOI O MÓDULO 2 PARA VOCÊ? ] - Programa ELAS',
	},
	mail9: {
		text: `Olá  *|PRIMEIRO_NOME|* , Tudo bem?

Está chegando a formatura do Programa ELAS - Turma 9!!!

E para garantir a melhor experiência possível, é importante que você complete as 3 atividades prévias até (7 dias antes do início do Módulo 3), ok?
...
O prazo para essas atividades é até (7 dias antes do início do Módulo 3).
...
Equipe ELAS`,
		...
		anexo: process.env.ANEXO_MAIL09,
	},
	mail10: {
		text: `Olá, aqui é a Vania, do Programa ELAS, tudo bem?

Entrei em contato com você há cerca de 2 meses atrás, para que você participasse de uma avaliação da *|NOMEALUNA|*. Lembra?
...
Quanto ao prazo você, pode responder até (7 dias antes do início do Módulo 3).
Contamos com você!
...
Vania Teofilo
Equipe ELAS`,
		subject: ' [ VOCÊ ESTÁ SENDO CONVIDADO(A) PARA AVALIAR A *|NOMEALUNA|* NOVAMENTE! ]',
	},
	mail11: {
		text: `Olá, *|PRIMEIRO_NOME|*!!
...
Equipe ELAS`,
	...
	mail12: {
		text: `Olá! Meu nome é Vania, e trabalho no Programa ELAS | Escola de Liderança, quem me passou seu contato foi a *|FNAME|*.  Ela é aluna do nosso curso de autoconhecimento, influência e liderança, e queremos pedir a sua ajuda para prestar uma homenagem para ELA! Podemos contar com você?  
 
No domingo dia (último dia do Módulo 3) será o último dia de aula do curso, e nós preparamos um encerramento muito especial!
 
Como será um dia marcante para ela, convidamos os familiares e/ou amigos mais próximos a ajudarem nessa homenagem (em casa, após o término do curso). Você pode usar a criatividade, lembrar de coisas que ela gosta, e organizar uma surpresa para a noite do domingo (último dia do Módulo 3). Pode ser uma carta carinhosa,  mensagens e incentivos coletados de amigos e familiares, e o que mais você achar que ela iria gostar.
 
A ideia é que ela, ao retornar para casa, tenha uma surpresa feita por você.  
 
A mensagem principal das homenagens é para dizer "Por que você tem orgulho da *|FNAME|*" Quanto mais mensagens ela receber mais será marcante essa transformação que a levará para um novo crescimento pessoal e profissional.   
...
Vania Teofilo
Equipe ELAS`,
		subject: 'Homenagem especial feita por você para *|FNAME|*',
	},
	mail13: {
		text: `Olá, *|PRIMEIRO_NOME|*,
